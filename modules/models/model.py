...
from modules.nn import util
from modules.nn.regularizers import RegularizerApplicator
...
class Model(torch.nn.Module):
    ...
    def forward_on_instance(self, instance: Any) -> Dict[str, numpy.ndarray]:
        # return self.forward_on_instances([instance])[0]
        pass

    def forward_on_instances(self,
                             instances: List[Any]) -> List[Dict[str, numpy.ndarray]]:
        """
        Parameters
        ----------
        instances : List[Any], required
